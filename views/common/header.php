...
if (SessionHelpers::isInBackOffice() && SessionHelpers::isAdmin()) { ?>
    <header class="sidebar">
        ...
        <ul>
           ...
           <li>
               <a href="/logout">
                   <svg class="icon" viewBox="0 0 24 24" width="1em" height="1em" xmlns="http://www.w3.org/2000/svg">
                       <path fill="currentColor" d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20M7,11H13V13H7V11Z"/></svg>
                   Déconnexion
               </a>
           </li>
        </ul>
...
<?php }else{
    ...
    <div class="easteregg">
        <div class="easteregg--container">
            <div class="easteregg--container--content">
                <div>
                    <p class="easteregg--title">Episode I</p>
                    <p class="easteregg--title">LA MENACE FANTOME</p>
                    <p>
                        La République Galactique est en pleine ébullition. La taxation des routes commerciales reliant les systèmes éloignés provoque la discorde.<br>
                        <br>
                        Pour régler la question, la cupide Fédération du Commerce et ses redoutables vaisseaux de guerre imposent un blocus à la petite planète Naboo.<br>
                        <br>
                        Face à ce dangereux engrenage, alors que le Congrès de la République s’enlise dans des débats sans fin, le Chancelier Suprême charge en secret deux Chevaliers Jedi, gardiens de la paix et de la justice dans la galaxie, de résoudre le conflit....</p>
                </div>
            </div>
        </div>
    </div>
